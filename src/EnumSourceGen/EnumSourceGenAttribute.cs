...
public sealed class EnumSourceGenAttribute : global::System.Attribute
{
    ...
    /// <summary>Override the name of the extension class. If not provided, the enum name with "Extensions" appended will be used. For example for an Enum called StatusCodes, the default name
    /// will be StatusCodesExtensions</summary>
