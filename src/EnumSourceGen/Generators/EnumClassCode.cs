...
internal static class EnumClassCode
{
    internal static string Generate(EnumSpec enumSpec, StringBuilder sb)
    {
        ...
        string enumsName = enumSpec.EnumsClassName;
...
#nullable enable
{{ns}}
public static partial class {{enumsName}}
{
    {{visibility}} static partial class {{cn}}
    {
...
""";
        ...
        string GetMemberValues()
        {
            ...
            {
                EnumMember enumVal = enumSpec.Members[i];
                sb.Append(sn).Append('.').Append(enumVal.Name).Append(",\n                ");
            }
        ...
        string GetUnderlyingValues()
        {
            ...
            {
                EnumMember enumVal = enumSpec.Members[i];
                sb.Append(enumVal.Value).Append(",\n                ");
            }
...
""");
    ...
    private static string GenerateBitString(EnumSpec spec)
    {
        // Type t = Type.GetType("System." + spec.UnderlyingType);
